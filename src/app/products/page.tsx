...
export default function Products() {
  return (
    <>
      ...
      <div className="relative isolate py-10 overflow-hidden flex-col flex h-full">
        <div
          ...
          <div className="mx-auto container px-6 lg:px-8">
            <div className=" gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <p className="text-4xl font-bold tracking-tight text-yellow-700 sm:text-2xl font-serif">
